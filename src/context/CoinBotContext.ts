...
export default class CoinBotContext {
  ...
  public async runCron() {
    ...
    //Todo cron doesn't work here for depositDistributionHandler(), make it work
  ...
  private async depositDistributionHandler() {
    ...
    for (let account in accounts) {
      ...
      for (let coin in accountsAssetsCoins) {
        ...
        await this.accountManager.updateAllocatedPriceInCoins(accountUsername,  newAllocatedPrice,coinSymbol);
